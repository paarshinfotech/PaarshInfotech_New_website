    ...
    <main className="bg-background text-foreground">
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        ...
        <div className="space-y-8 text-foreground/80 prose prose-lg max-w-none">
          <p>
            The Privacy Notice for PAARSH INFOTECH PVT LTD (‘We’, ‘US’, or ‘our’)
            describes how and in what way we might access, collect, store, use,
            and/or share (‘process’) your personal information when you use our
            service (‘SERVICES’), including when you:
          </p>
          <ul className="list-disc list-inside space-y-1">
            <li>
              Visit our website at https://paarshinfotech.com or any website of
              ours that links to this Privacy Notice
            </li>
            <li>
              Download and use our mobile application (Paarsh EDU), or any other
          ...
          <p>
            ...
            you understand your privacy rights and choices. We are responsible
            ...
            concerns, please contact us at paarshinfotech@gmail.com.
          </p>

          <div className="p-6 bg-secondary/50 rounded-lg">
            <h2 className="text-2xl font-bold text-primary mb-4">SUMMARY OF KEY POINTS</h2>
            <p className="italic">
              This summary provides key points from our Privacy Notice, but you can
              find out more details about any of those topics by using our table of
          ...
          <div id="what-info">
            <h2 className="text-2xl font-bold text-primary">1. WHAT INFORMATION DO WE COLLECT?</h2>
          ...
          <div id="how-process">
            <h2 className="text-2xl font-bold text-primary">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
          ...
          <div id="social-logins">
            ...
            <p>We will use the information we receive only for the purposes that are described in this Privacy Notice or that are otherwise made clear to you on the relevant Services. Please note that we do not control, and are not responsible for, other uses of your personal information by your third-party social media provider. We recommend that you review their privacy notice to understand how they collect, use, and share your personal information, and how you can set your privacy preference on their sites and apps.</p>
          </div>

          <div id="how-long">
            <h2 className="text-2xl font-bold text-primary">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
            ...
            <p>When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize such information, or if this is not possible (for example, because our personal information has been stored in backup archives), then we will securely store your personal information and isolate it from any further processing until deletion is possible.</p>
          </div>
          ...
          <div id="updates">
            <h2 className="text-2xl font-bold text-primary">9. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
          ...
          <div id="review-data">
            <h2 className="text-2xl font-bold text-primary">11. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
