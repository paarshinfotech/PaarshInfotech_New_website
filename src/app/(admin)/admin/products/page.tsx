            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Manage your company's product offerings and their visibility.</CardDescription>
                    </div>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-2">
                                            <Switch
                                                ...
                                                onCheckedChange={(checked) => handleTogglePublished(product.id, checked)}
                                            />
