    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Manage all content sections of your public Media page.</p>
            </div>
            ...
            <Tabs defaultValue="gallery">
                ...
                <TabsContent value="slider" className="mt-6">
                    <SliderManagementTab items={sliderImages} setItems={setSliderImages} />
                </TabsContent>
