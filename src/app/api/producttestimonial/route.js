...
import ProductTestimonialModel from "../../../../models/ProductTestimonial..model"; // Adjust path to your model
...
export async function POST(request) {
  try {
    ...
    const newTestimonial = new ProductTestimonialModel({
      quote,
      name,
      title,
      avatar,
...
export async function PATCH(request) {
  try {
    ...
    const testimonial = await ProductTestimonialModel.findByIdAndUpdate(
      _id,
      updateData,
