    ...
    <section className="py-20 md:py-32 bg-secondary">
      <div className="container max-w-4xl text-center">
        ...
        <div className="relative">
          <LuQuote className="w-24 h-24 text-primary/5 absolute -top-8 -left-8 transform -rotate-12" />
          <LuQuote className="w-24 h-24 text-primary/5 absolute -bottom-8 -right-8 transform rotate-12" />
