        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              We are dedicated to building strong, lasting relationships with
              our clients, founded on trust and mutual success. Our core
              principle is to deliver exceptional value and quality in every
              project we undertake.
            </p>
            <p className="text-lg text-muted-foreground">
              We believe in nurturing future talent through our comprehensive
              internship program. Interns gain invaluable real-world experience
              by working on live projects under the guidance of our senior
              developers, preparing them for a successful career in the tech
              industry.
            </p>
          </div>
