...
const cultureImages = [
  { src: "https://placehold.co/600x800.png", alt: "Team celebration", dataAiHint: "team celebration", className: "lg:col-span-2 lg:row-span-2" },
  { src: "https://placehold.co/600x400.png", alt: "Collaborative workshop", dataAiHint: "workshop collaboration", className: "lg:col-span-2" },
  { src: "https://placehold.co/600x400.png", alt: "Company hackathon", dataAiHint: "hackathon event", className: "" },
  { src: "https://placehold.co/600x400.png", alt: "Diwali party at office", dataAiHint: "office party", className: "" },
];
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 auto-rows-[250px] gap-4">
          {cultureImages.map((image, index) => (
            <ImagePreviewModal key={index} imgSrc={image.src} alt={image.alt}>
              <div className={`relative rounded-lg overflow-hidden group shadow-lg cursor-pointer ${image.className}`}>
                <Image
                  src={image.src}
                  alt={image.alt}
                  fill
