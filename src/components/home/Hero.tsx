...
export default function Hero() {
  return (
    <section className="relative min-h-[60vh] py-4 flex items-center justify-center overflow-hidden">
      {/* Three.js Background */}
      <HeroBackground />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              thrive in the digital landscape. Beautiful design, powerful
            ...
            >
              <motion.div
                whileHover={{
                  ...
                  y: -5,
                  boxShadow:
                    "0 25px 30px -10px rgba(59, 130, 246, 0.4), 0 15px 15px -10px rgba(59, 130, 246, 0.3)",
              ...
              <motion.div
                whileHover={{
                  ...
                  y: -5,
                  boxShadow:
                    "0 25px 30px -10px rgba(139, 92, 246, 0.4), 0 15px 15px -10px rgba(139, 92, 246, 0.3)",
                  transition: { duration: 0.3 },
                }}
                whileTap={{ scale: 0.95 }}
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
