            ...
            <Link key={service.slug} href={`/services/${service.slug}`} className="block group h-full">
                <Card className="flex flex-col h-full transition-all duration-300 ease-in-out hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 border-transparent hover:border-primary/20 bg-secondary/30">
                    <CardHeader className="items-center text-center">
                        <div className="p-4 bg-primary/10 rounded-full w-fit mb-4 transition-all duration-300 group-hover:bg-accent group-hover:scale-110">
                            <service.Icon className="w-10 h-10 text-primary transition-colors group-hover:text-accent-foreground" />
                        </div>
                    ...
                    <CardFooter>
                       <div className="relative inline-flex items-center justify-center font-semibold text-primary group-hover:text-accent-foreground transition-colors duration-300 overflow-hidden w-full text-center mt-4 rounded-md">
                            <span className="relative z-10 flex items-center py-2">
                                Learn More
                                <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
                            </span>
                             <div className="absolute inset-0 bg-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
                        </div>
                    </CardFooter>
                </Card>
            </Link>
