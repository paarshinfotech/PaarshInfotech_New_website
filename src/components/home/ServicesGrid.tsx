    ...
    <div className="container max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[...Array(3)].map((_, index) => (
          <div
            key={index}
            className="animate-pulse flex flex-col h-full bg-white rounded-xl p-6 shadow-md"
          >
...
export default function ServicesGrid() {
        ...
        <div className="container max-w-7xl">
          <div className="border border-destructive/50 bg-destructive/5 text-center p-6 rounded-xl">
            ...
            <p className="text-destructive/80 mt-1 mb-4 text-sm">
              We couldn't load our services right now. Please try again in a few
              moments.
            </p>
  ...
  const publishedServices =
    servicesData?.data?.filter((s: ApiService) => s.published) || [];
                ...
                >
                  ...
                  >
                    <div className="relative h-full">
                      ...
                      <div className="relative h-full flex flex-col bg-gradient-to-br from-white to-gray-50 rounded-md overflow-hidden border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:border-transparent p-6">
                        <div className="flex items-start mb-5">
                          {/* Icon container with gradient background */}
                          <div className="flex-shrink-0 p-3 bg-primary rounded-md mr-4 shadow-md">
                            ...
                            .map((offering, idx) => (
                              ...
                              >
                                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center">
                                  <LuCheck className="w-3 h-3 text-blue-900" />
                                </div>
                        ...
                        <div className="mt-auto">
                          <div className="relative group overflow-hidden inline-flex items-center font-semibold text-blue-900 transition-colors duration-300 py-2 px-4 rounded-md">
                            {/* Sliding overlay */}
                            <div className="absolute inset-0 bg-blue-900 w-0 group-hover:w-full transition-all duration-300 ease-in-out z-0"></div>

                            {/* Text and icon */}
                            <span className="relative z-10 flex items-center text-sm text-blue-900 group-hover:text-white transition-colors duration-300">
                              Learn More
