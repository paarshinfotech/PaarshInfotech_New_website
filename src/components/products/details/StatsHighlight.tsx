...
import { LuPercent, LuClock, LuZap } from "react-icons/lu";
...
const stats: {
  ...
  { value: 45, label: "Increase in Productivity", Icon: LuZap, suffix: "%" },
  { value: 8, label: "Hours Saved Per Week", Icon: LuClock, suffix: "hrs" },
  { value: 99, label: "Customer Satisfaction", Icon: LuPercent, suffix: "%" },
];
