...
import { ArrowUpRight, BarChart, CheckCircle, Zap, TrendingUp, Users } from "lucide-react";
import type { LucideIcon } from "lucide-react";

const outcomesData: { title: string; metric: string; description: string; Icon: LucideIcon }[] = [
    {
        ...
        <section className="py-16 md:py-24 bg-secondary">
            <div className="container max-w-7xl">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-primary">Visualize the Outcome</h2>
                    <p className="mt-4 text-lg text-foreground/70 max-w-3xl mx-auto">
                        We don't just deliver services; we deliver tangible results that drive business growth.
                    </p>
                </div>
