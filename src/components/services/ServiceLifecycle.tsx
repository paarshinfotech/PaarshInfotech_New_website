    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="container max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-primary">Our Proven Process</h2>
          <p className="mt-4 text-lg text-foreground/70 max-w-3xl mx-auto">
            A streamlined and transparent journey to bring your ideas to life, from concept to launch and beyond.
          </p>
        </div>
