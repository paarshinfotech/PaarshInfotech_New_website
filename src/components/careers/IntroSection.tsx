        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              At Paarsh Infotech, we believe our people are our greatest asset.
              We foster a collaborative and inclusive work environment where
              creativity thrives and every team member has the opportunity to
            ...
            <blockquote className="text-xl italic text-foreground/80 border-l-4 border-accent pl-6">
              ...
              <footer className="mt-4 text-base not-italic">
                <span className="font-semibold text-primary">{ceoName}</span>,{" "}
                <span className="text-muted-foreground">{ceoTitle}</span>
              </footer>
            </blockquote>
          </div>
