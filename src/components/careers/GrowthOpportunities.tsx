    ...
    <section className="py-16 md:py-24 bg-secondary">
      <div className="container max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-primary">Your Pathway to Growth</h2>
          <p className="mt-4 text-lg text-foreground/70 max-w-3xl mx-auto">
            We are committed to your professional development and provide a clear path for advancement.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {growthOpportunitiesData.map(({ title, description, Icon }) => (
            <Card key={title} className="text-center p-6 group transition-all duration-300 ease-in-out hover:bg-background hover:shadow-xl hover:-translate-y-2">
