  ...
  const handleSave = async (data: any) => {
    try {
      if (selectedImage) {
        ...
        await addImage({ page: 'about', ...data }).unwrap();
        toast({ title: "Image Added", description: "The new image has been added to the about page." });
      }
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Manage the images displayed on the public about us page.</CardDescription>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
           ...
           {images.length === 0 && (
            <div className="text-center py-12 text-muted-foreground">
              <p>No images found for the about page.</p>
