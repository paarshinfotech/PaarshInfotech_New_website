...
export function BtsManagementTab({ items, setItems }: BtsManagementTabProps) {
    ...
    const [selectedItem, setSelectedItem] = useState<BehindTheScenesItem | null>(null);
        ...
        <>
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Manage the three cards in the "A Day in the Life" section.</CardDescription>
                </CardHeader>
                <CardContent>
