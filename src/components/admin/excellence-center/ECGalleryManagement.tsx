...
export function ECGalleryManagement() {
  ...
  const handleSave = async (data: any) => {
    try {
      ...
      toast({ title: "Error", description: error.data?.error || "Could not save item.", variant: "destructive" });
    }
  };
  ...
  return (
    <>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Manage the gallery images for the Excellence Center page.</CardDescription>
          </div>
      ...
      <ECGalleryFormModal isOpen={isModalOpen} onOpenChange={setIsModalOpen} onSave={handleSave} item={selectedItem} />
...
const SortableImageCard = ({ item, handleEdit, handleDelete }: { item: ECGalleryItem; handleEdit: (item: ECGalleryItem) => void; handleDelete: (item: ECGalleryItem) => void; }) => {
